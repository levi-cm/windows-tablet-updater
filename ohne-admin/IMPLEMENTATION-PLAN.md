...
**Goal:** Build a separate standard-user updater package under `ohne-admin/` while keeping the original admin package under `mit-admin/`.
...
**Files:**
- Create: `ohne-admin/tests/static_checks.sh`
...
Run: `bash ohne-admin/tests/static_checks.sh`
Expected: FAIL because `ohne-admin/Windows-Tablet-Updater-NoAdmin.ps1` does not exist yet.

### Task 2: No-Admin Package Files

**Files:**
- Create: `ohne-admin/Windows-Tablet-Updater-NoAdmin.ps1`
- Create: `ohne-admin/Tablet-Updater-Starten-NoAdmin.bat`
- Create: `ohne-admin/readme.md`
- Create: `ohne-admin/ABLAUF-DIAGRAMM.txt`
...
**Files:**
- Admin package files must remain unchanged except for moving into `mit-admin/`:
  - `mit-admin/Windows-Tablet-Updater.ps1`
...
Run: `sha256sum mit-admin/Windows-Tablet-Updater.ps1 mit-admin/Tablet-Updater-Starten.bat mit-admin/readme.md mit-admin/ABLAUF-DIAGRAMM.txt`
Expected:
```text
4f36e7f94112cc9f79c50a9900c3a3d1364520044c7c5cc473e6950e5f681770  mit-admin/Windows-Tablet-Updater.ps1
a4684600157853d3cc923d084f34e7939ca8019b5810fff8cbf2bbadfa04e263  mit-admin/Tablet-Updater-Starten.bat
f28f0bdd8cc2553a463c312ab282fe88346298145a7af673d8ab31e2c6d4cf52  mit-admin/readme.md
abc07fe6296fde2be3cee2514f43e76e86b32d5d22deb37e2ee85c698d92deb3  mit-admin/ABLAUF-DIAGRAMM.txt
```
